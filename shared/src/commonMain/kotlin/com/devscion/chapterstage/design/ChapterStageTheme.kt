...
data class StageColors(
    val background: Color = Color(0xFF07100F),
    val backgroundHigh: Color = Color(0xFF111720),
    val backgroundLow: Color = Color(0xFF050708),
    val surface: Color = Color(0xB3192630),
    val surfaceElement: Color = Color(0x33FFFFFF),
    val surfaceHigh: Color = Color(0x6632454D),
    val glassSurface: Color = Color(0x991B2830),
    val glassHighlight: Color = Color(0x29FFFFFF),
    val glassShadow: Color = Color(0x6603080A),
    val line: Color = Color(0x20FFFFFF),
    val lineHigh: Color = Color(0x38FFFFFF),
    val primary: Color = Color(0xFF7BE0C3),
    val primarySoft: Color = Color(0x2E7BE0C3),
    val primaryText: Color = Color(0xFFD2FFF2),
    val textPrimary: Color = Color(0xFFF4F7F4),
    val textSecondary: Color = Color(0xFFB6C3C4),
    val textTertiary: Color = Color(0xFF748486),
    val success: Color = Color(0xFF62E6A8),
    val warning: Color = Color(0xFFFFCF68),
    val error: Color = Color(0xFFFF6C8F),
    val cyan: Color = Color(0xFF59D7FF),
    val pink: Color = Color(0xFFFF9BCA),
    val violet: Color = Color(0xFFA98CFF),
)
...
private val ChapterStageColorScheme: ColorScheme = darkColorScheme(
    ...
    onPrimary = StageColors().background,
